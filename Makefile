...
bundle-minimal:
	@cat "$(REPO)/vim/.vim/core.vim" "$(REPO)/vim/.vim/mappings.vim" > "$(REPO)/vim/.vimrc_minimal_standalone"
	@echo 'colorscheme slate' >> "$(REPO)/vim/.vimrc_minimal_standalone"
	@echo "Written: $(REPO)/vim/.vimrc_minimal_standalone"
